...
public class FailedToProcessFileException extends RuntimeException {
     ...
     * @since 1.4
     */
    public FailedToProcessFileException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.7
     */
    public FailedToProcessFileException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
