...
public class InvalidShortUrlException extends RuntimeException {
     ...
     * @since 1.4
     */
    public InvalidShortUrlException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.7
     */
    public InvalidShortUrlException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
